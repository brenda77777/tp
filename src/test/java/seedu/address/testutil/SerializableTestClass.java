...
public class SerializableTestClass {
    ...
    private static final String ROLE_TEST_VALUE = "This is a test class";
    ...
    public static String getRoleTestValue() {
        return ROLE_TEST_VALUE;
    }
